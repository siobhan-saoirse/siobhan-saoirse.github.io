...
var Bonzi = (function () {
    ...
    BonziData = {
        ...
        event_list_joke_mid: [
            ...
            [
                { type: "text", text: "What is in the middle of Portugal?" },
                { type: "text", text: "A inflatable 14 year old retard." },
            ],
            [
        ...
        event_list_fact_mid: [
            ...
            [
                ...
                { type: "html", text: "<img src='./img/misc/topjej.png'></img>", say: "BAAAAAAAAAAAAAAAAAAAAAAAAA!" },
                { type: "text", text: "What the fuck! Stop spamming you little shit!" },
                { type: "html", text: "<img src='./img/misc/topjej.png'></img>", say: "BABABABABSAJKASNALKNLKSADNLKSAMSNKLSANDSJLKANDLSKSADNSAKLSANDSMDSMSDNKSJDSASAKNDMSSANAMDNSALKXLKXLXKXMNSMN" },
                { type: "text", text: "You know what? Screw you guys, i'm going to play some gacha life!" },
            ],
        ],
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var spriteColors = ["black", "blue", "brown", "green", "purple", "red", "pink", "pope"], i = 0; i < spriteColors.length; i++) {
    ...
    $(function () {
        $("body").on("click", "#page_sidebar_close", function () {
            ...
            socket.on("ban", function (data) {
                (window.banned = !0), (window.banData = data), $("#page_ban").show(), $("#ban_reason").html(data.reason), $("#ban_end").html(new Date(data.end).toString());
            }),
            socket.on("kick", function (data) {
                (window.kicked = !0), (window.kickData = data), $("#page_kick").show(), $("#kick_reason").html(data.reason);
            }),
...
var isMobileApp = !1,
    ...
    isChromeBrowser = !1,
    urlChrome = "https://chrome.google.com/webstore/detail/bonziworld/",
    isiOS = !1,
    urlGPlay = "https://play.google.com/store/apps/details?id=";
